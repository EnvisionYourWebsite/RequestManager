  <script type="text/javascript">
    ...
    var initEvent = function() {
      $('.votebtn').click(function(e){
            ...
            if (!$('#feature-' + id + ' .IdeaVoteForm').is(':visible'))
            {
        ...
        $('.votebtn-value').click(function(e){
          e.preventDefault();
            ...
            $(this).addClass('btn-primary');
             <?php if (!isset($is_user_logged_in) && !CI_Settings::get('AnonymousPosting')): ?>
              if (!connected) {
            ...
            /* if ($(this).parents('#featuresContainer').length === 0) 
                   return;*/
